...
(function() {
  $(function() {
    return $("ul#flash").delay(5000).slideUp(500);
  });
...
(function() {
  $(function() {
    return $('#workspaces').sortable({
      update: function() {
        return $.ajax($('li#back-link a').attr('href') + "/workspaces/sort", {
          type: 'PUT',
          handle: '.handle',
          dataType: 'script',
          data: $('#workspaces').sortable('serialize'),
          complete: function() {
            return $('#workspaces').effect('highlight');
          }
        });
      }
    });
